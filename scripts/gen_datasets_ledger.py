...
generation time (unlike the retired hand-embedded dashboard, kept as a design
artefact at specs/dashboard/index.html). Regenerate with
`just gen-datasets-ledger`.
"""
...
<a href="../">&larr; Docs home</a><span>&middot;</span><a href="../overview/">Schema overview</a><span>&middot;</span><a href="../elements/">Element reference</a>
</nav>
...
This page supersedes the hand-authored illustrative completeness ledger, retired
to <code>specs/dashboard/index.html</code> as a design artefact.</footer>
</div>
<script>{JS}</script>
</body>
</html>
