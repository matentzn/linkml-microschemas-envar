# Contributing to linkml-microschemas-envar

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
linkml-microschemas-envar. These guidelines are not strict rules.
...
The linkml-microschemas-envar team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the linkml-microschemas-envar technical leads
...
[issues]: https://github.com/monarch-initiative/linkml-microschemas-envar/issues/
[pulls]: https://github.com/monarch-initiative/linkml-microschemas-envar/pulls/
